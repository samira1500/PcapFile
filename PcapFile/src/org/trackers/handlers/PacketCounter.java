...
public class PacketCounter {
	...
	static String folderpath = "C:\\Users\\kasim\\Desktop\\pcapfiles\\";
	...
	public static void main(String[] args) {
		...
		for (File f : files) {
			...
			pcap.loop(-1, new JPacketHandler() {
				...
				@Override
				public void nextPacket(JPacket arg0, Object arg1) {
			...
			System.out.println("File : " + f.getName() + " Number of Packets : " + count);
